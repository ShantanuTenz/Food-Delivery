...
const IngredientTable = () => {
  ...
  return (
    <Box>
        <Card className='mt-1'>
            <CardHeader action={<IconButton onClick={handleOpen} aria-label='settings'><Create /></IconButton> } title={"Ingredients"} sx={{pt:2, alignItems: "center"}} />
            ...
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    ...
                    {orders.map((row) => (
                        ...
                        <TableCell align="right">{"availible"}</TableCell>
                        </TableRow>
                    ))}
                    </TableBody>
                </Table>
